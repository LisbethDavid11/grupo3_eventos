...
public class CrearManualidad extends JFrame {
    // Campos de texto
    private JTextField campoPrecioManualidad;
    ...
    // Campos de búsqueda y promp de texto
    ...
    public CrearManualidad() {
        ...
        campoPrecioManualidad.addKeyListener(new KeyAdapter() {
            @Override
            public void keyTyped(KeyEvent e) {
                char c = e.getKeyChar();
                String text = campoPrecioManualidad.getText();
        ...
        botonGuardar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (campoNombre.getText().trim().isEmpty()) {
                    validacion++;
                    mensaje += "Nombre de la manualidad\n";
                }
                ...
                String precioText = campoPrecioManualidad.getText().trim();
                    ...
                    if (cantidadMaterial <= cantidadExistente) {
                        ...
                        if (precioMaterial >= 1) {
                            ...
                            if (!materialDuplicado) {
                                ...
                                jtableMateriales.setModel(cargarDetallesMateriales());
                                jtableMateriales.getColumnModel().getColumn(5).setCellRenderer(new CrearManualidad.ButtonRenderer());
                                jtableMateriales.getColumnModel().getColumn(5).setCellEditor(new CrearManualidad.ButtonEditor());
    ...
    // Método para obtener la cantidad existente en la base de datos
    ...
    // Método para guardar las manualidades
    private void guardarManualidades() {
        String nombre = campoNombre.getText().trim();

        String precioManualidadText = campoPrecioManualidad.getText().replace("L ", "").replace(",", "").replace("_", "");
    ...
    // Método para guardar los datelles de la manualidad
    ...
    private void configurarTablaMateriales() {
        ...
        if (columnCount > 0) {
            ...
            columnModel.getColumn(5).setCellRenderer(new CrearManualidad.ButtonRenderer());
    ...
    class ButtonEditor extends AbstractCellEditor implements TableCellEditor, ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            eliminarDetalleManualidad(id_material);
    ...
    // Método para eliminar detalles de la manualidad
    private void eliminarDetalleManualidad(int id_material) {
        try (Connection connection = sql.conectamysql();
             PreparedStatement preparedStatement = connection.prepareStatement(
                     "DELETE FROM detalles_manualidades WHERE manualidad_id IS NULL AND material_id = ?")) {
            preparedStatement.setInt(1, id_material);
            preparedStatement.executeUpdate();
        } catch (SQLException e) {
            e.printStackTrace();
