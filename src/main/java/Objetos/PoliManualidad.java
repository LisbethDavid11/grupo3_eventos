...
public class PoliManualidad extends PoliProductosGeneral {
    ...
    public PoliManualidad() {
        super();
    }

    public PoliManualidad(int idDetalle, int id, String nombre, int cantidad, double precio, String tipo) {
