...
public class PoliResumenPromocion extends PoliProductosGeneral {
    ...
    public PoliResumenPromocion() {
        super();
    }

    public PoliResumenPromocion(int idDetalle, int id, String nombre, int cantidad, double precio, String tipo) {
